...
export default function HeroBanner() {
  ...
  return (
    <div className="relative w-full overflow-hidden" style={{ background: 'linear-gradient(135deg, #4a4a4a 0%, #2a2a2a 50%, #1a1a1a 100%)' }}>
      ...
      {/* Decorative badge */}
      <div className="hidden lg:block absolute right-[8%] top-[42%] -translate-y-1/2">
        <div className="w-[150px] h-[150px] rounded-full bg-accent/20 flex items-center justify-center">
          <div className="w-[120px] h-[120px] rounded-full bg-accent/30 flex items-center justify-center">
            <div className="text-center px-2">
              <p className="text-[10px] text-gray-200">2014~2026 12년 연속</p>
              <p className="text-[13px] font-bold text-white mt-1">등록업체수 1위</p>
              <p className="text-[13px] font-bold text-accent">매입문의수 1위</p>
            </div>
          </div>
        </div>
      </div>
