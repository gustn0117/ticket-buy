    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-2xl border border-gray-200/60 p-6 shadow-sm">
          ...
          <p className="text-3xl font-extrabold text-gray-900 tracking-tight">0<span className="text-lg font-semibold text-gray-400 ml-0.5">건</span></p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200/60 p-6 shadow-sm">
          ...
          <div className="text-sm space-y-1.5 mt-2">
            ...
            <div className="flex justify-between"><span className="text-gray-500">완료</span><span className="font-bold text-gray-800">0건 0원</span></div>
          </div>
        </div>
        <div className="bg-white rounded-2xl border border-gray-200/60 p-6 shadow-sm">
      ...
      <div className="bg-white rounded-2xl border border-gray-200/60 p-6 shadow-sm">
        ...
        <div className="flex gap-5 text-sm mb-4">
          <span>거래완료 <span className="text-gray-900 font-bold">0건</span> (0원)</span>
