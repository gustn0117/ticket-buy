...
const faqData: { category: string; items: FAQItem[] }[] = [
  {
    ...
    items: [
      ...
      { q: '업체 회원으로 가입하려면 어떤 서류가 필요한가요?', a: '사업자등록번호, 대표자명, 연락처가 필요합니다. 업체등록문의 페이지에서 신청하실 수 있으며, 승인 후 업체 로그인이 가능합니다.' },
    ],
  },
  {
    category: '구매',
    items: [
      ...
      { q: '구매 후 상품권은 언제 받을 수 있나요?', a: '상품권 수령 시기는 업체와 합의한 발송 예정일에 따릅니다. 모바일 상품권의 경우 문자로 즉시 전달받을 수 있으며, 택배의 경우 발송 후 1~3일 소요됩니다.' },
    ],
  },
  {
    category: '판매',
