  ...
  return (
    <div className="max-w-[800px] mx-auto px-5 py-8">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8">
        ...
        <p className="text-[12px] text-amber-700 mb-2">티켓바이는 상품권 거래를 위한 게시글 등록·업체 정보 노출 등 중개 기능만을 제공합니다. 결제 대행(에스크로) 서비스는 제공하지 않으며, 거래 대금의 지급 및 상품권 전달은 회원·업체 간 직접 이루어집니다.</p>
